...
func MetadataEnsureWithSdf(b []byte) ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }

// 已经有了

// 16=1+2+13 @setDataFrame
...
//
// @return 返回的内存块为内部独立申请
func MetadataEnsureWithoutSdf(b []byte) ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }
