...
func (m *Muxer) Start() { _ = "STUB: not implemented"; return }

func (m *Muxer) Dispose() { _ = "STUB: not implemented"; return }
...
func (m *Muxer) OnPatPmt(b []byte) { _ = "STUB: not implemented"; return }
...
func (m *Muxer) FeedPatPmt(b []byte) { _ = "STUB: not implemented"; return }
...
//
// @return: 理论上，只有文件操作失败才会返回错误
func (m *Muxer) openFragment(ts uint64, discont bool) error { _ = "STUB: not implemented"; return nil }
...
func (m *Muxer) fragsCapacity() int { _ = "STUB: not implemented"; return 0 }

func (m *Muxer) makeFrags() { _ = "STUB: not implemented"; return }

// getFragmentId 获取+1递增的序号
func (m *Muxer) getFragmentId() int { _ = "STUB: not implemented"; return 0 }

func (m *Muxer) getFrag(n int) *fragmentInfo { _ = "STUB: not implemented"; return nil }
...
func (m *Muxer) getCurrFrag() *fragmentInfo { _ = "STUB: not implemented"; return nil }
...
func (m *Muxer) iterateFragsInPlaylist(fn func(*fragmentInfo)) { _ = "STUB: not implemented"; return }
