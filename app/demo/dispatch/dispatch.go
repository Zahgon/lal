...
func OnPubStartHandler(w http.ResponseWriter, r *http.Request) { _ = "STUB: not implemented"; return }

func OnPubStopHandler(w http.ResponseWriter, r *http.Request) { _ = "STUB: not implemented"; return }

func OnSubStartHandler(w http.ResponseWriter, r *http.Request) { _ = "STUB: not implemented"; return }
...
func OnSubStopHandler(w http.ResponseWriter, r *http.Request) { _ = "STUB: not implemented"; return }

func OnUpdateHandler(w http.ResponseWriter, r *http.Request) { _ = "STUB: not implemented"; return }

// pub exist

func logHandler(w http.ResponseWriter, r *http.Request) { _ = "STUB: not implemented"; return }
